...
import static com.demo.utilities.PageUtils.driver;
import static com.demo.utilities.PageUtils.currentDirectory;
...
public class ExtentReportNG {
    ...
    public static String screenshots(String imageName) {
        ...
        return (imageLocation + "_" + imageName + ".jpg");
    }
    ...
    public static String randomScreenshots() {
        ...
        return (imageLocation + "_" + uuid + ".jpg");
    }
